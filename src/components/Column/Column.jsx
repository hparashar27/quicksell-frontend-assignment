...
import dotIcon from "../../assests/3_dot_menu.svg"
    ...
    return (
        <div className='column'>
            ...
            <div className='cards-container'>
                {tickets.map((ticket) => <Card key={ticket.id} ticket={ticket} userData={userIdToData[ticket.userId]} hideStatusIcon={grouping === "status"} hideProfileIcon={grouping === "user"} groupBy={groupBy} grouping={grouping}/>)}
            </div>
        </div>
    );
}
